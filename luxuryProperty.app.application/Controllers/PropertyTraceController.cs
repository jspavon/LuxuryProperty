...
namespace luxuryProperty.app.application.Controllers
{
    ...
    public class PropertyTraceController : ControllerBase
    {
        ...
        public PropertyTraceController(ILogger<PropertyTraceController> logger, IMapper mapper, IBrowserDetector browserDetector, IPropertyTraceService service)
        {
        ...
        [ProducesResponseType(typeof(ResponseService<IEnumerable<PropertyTraceDto>>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetAllAsync(int? page, int? limit)
        {
            ...
            var response = new ResponseService<IEnumerable<PropertyTraceDto>>
            {                
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(ResponseService<PropertyTraceDto>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetByIdAsync(string id)
        {
            ...
            var response = new ResponseService<PropertyTraceDto>
            {
                Status = existResult,
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(PropertyTraceCreateModel))]
        public async Task<IActionResult> Post([FromBody] PropertyTraceCreateModel request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json, Type = typeof(PropertyTraceUpdateModel))]
        public async Task<IActionResult> PutAsync(string id, [FromBody] PropertyTraceUpdateModel request)
        {
            ...
            var objRequest = _mapper.Map<PropertyTraceUpdateDto>(request);
