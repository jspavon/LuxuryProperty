...
namespace luxuryProperty.app.application.Controllers
{
    ...
    public class OwnerController : ControllerBase
    {
        ...
        public OwnerController(ILogger<OwnerController> logger, IMapper mapper, IBrowserDetector browserDetector, IOwnerService service)
        {
        ...
        [ProducesResponseType(typeof(ResponseService<IEnumerable<OwnerDto>>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetAllAsync(int? page, int? limit)
        {
            ...
            var response = new ResponseService<IEnumerable<OwnerDto>>
            {
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(ResponseService<OwnerDto>), (int)HttpStatusCode.OK)]
        public async Task<IActionResult> GetByIdAsync(string id)
        {
            ...
            var response = new ResponseService<OwnerDto>
            {
                Status = existResult,
        ...
        public async Task<IActionResult> Post([FromBody] OwnerCreateModel request)
        {
        ...
        public async Task<IActionResult> PutAsync(string id, [FromBody] OwnerUpdateModel request)
        {
            ...
            var objRequest = _mapper.Map<OwnerUpdateDto>(request);
