...
namespace luxuryProperty.app.applicationCore.Interfaces
{
    ...
    public interface IUsersService
    {
        ...
        Task<List<UsersDto>> GetAllAsync(int page, int limit, string orderBy, bool ascending = true);
        /// <summary>
        ...
        /// <remarks>Jhon Steven Pavón Bedoya</remarks>
        Task<(bool status, string id)> Post(UsersDto entity);
        /// <summary>
        ...
        /// <remarks>Jhon Steven Pavón Bedoya</remarks>
        Task<bool> PutAsync(string id, UsersUpdateDto entity);
        /// <summary>
        ...
        /// <returns>Task&lt;System.Boolean&gt;.</returns>
        /// <remarks>Jhon Steven Pavón Bedoya</remarks>
        Task<bool> DeleteAsync(string id, bool active);
        /// <summary>
        /// ValidateUser the asynchronous.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>Task&lt;System.Boolean&gt;.</returns>
        /// <remarks>Jhon Steven Pavón Bedoya</remarks>
