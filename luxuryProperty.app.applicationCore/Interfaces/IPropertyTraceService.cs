...
namespace luxuryProperty.app.applicationCore.Interfaces
{
    ...
    public interface IPropertyTraceService
    {
        ...
        /// <returns>Task&lt;PropertyTraceDto&gt;.</returns>
        ...
        /// <returns>Task&lt;IEnumerable&lt;PropertyTraceDto&gt;&gt;.</returns>
        Task<List<PropertyTraceDto>> GetAllAsync(int page, int limit, string orderBy, bool ascending = true);
        /// <summary>
        ...
        /// <remarks>Jhon Steven Pavón Bedoya</remarks>
        Task<(bool status, string id)> Post(PropertyTraceDto entity);
        /// <summary>
        ...
        /// <remarks>Jhon Steven Pavón Bedoya</remarks>
        Task<bool> PutAsync(string id, PropertyTraceUpdateDto entity);
        /// <summary>
